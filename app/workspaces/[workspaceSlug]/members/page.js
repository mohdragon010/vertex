                    ...
                    <DialogContent className="sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-base text-foreground mt-2">
                                You aren't an admin of this workspace, so you don't have permission to view or manage members.
                            </DialogDescription>
                        </DialogHeader>
                        <DialogFooter>
            ...
            <header className="mb-16">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-xl max-w-2xl leading-relaxed font-medium">
                        Add or remove members for <strong className="text-foreground">{workspace.name}</strong>. Anyone added here will have access to all projects in this workspace.
                    </p>
                </motion.div>
            </header>
